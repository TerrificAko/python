...
#define D_I_TIA_FB_RES_BIT_OFFSET               (10U)
#define D_I_TIA_FB_RES_BIT_LEN                  (5U)
#define D_I_TIA_FB_RES_BIT_MASK                0x7f00U

#define D_I_TIA_STG1_ITRIM_BIT_OFFSET         (18U)
#define D_I_TIA_STG1_ITRIM_BIT_LEN             (3U)
#define D_I_TIA_STG1_ITRIM_BIT_MASK           0x1c0000U

#define D_I_TIA_STAG1_ISEL_BIT_OFFSET          (21U)
#define D_I_TIA_STAG1_ISEL_BIT_LEN             (2U)
#define D_I_TIA_STAG1_ISEL_BIT_MASK            0x600000U

#define D_LNA_STAGE2_AGC_BIT_OFFSET             (29U)
#define D_LNA_STAGE2_AGC_BIT_LEN                (2U)
#define D_LNA_STAGE2_AGC_BIT_MASK               0x60000000U

#define ADDR_0X0820                             (UWB_BASE_ADDR + 0x0820)

#define D_Q_TIA_FB_RES_BIT_OFFSET               (11U)
#define D_Q_TIA_FB_RES_BIT_LEN                  (5U)
#define D_Q_TIA_FB_RES_BIT_MASK                0xf800U

#define ADDR_0X0850                             (UWB_BASE_ADDR + 0x0850)

#define D_I_TIA_FB_RES_2ND_BIT_OFFSET          (11U)
#define D_I_TIA_FB_RES_2ND_BIT_LEN             (5U)
#define D_I_TIA_FB_RES_2ND_BIT_MASK            0xf800U

#define D_Q_TIA_FB_RES_2ND_BIT_OFFSET           (19U)
#define D_Q_TIA_FB_RES_2ND_BIT_LEN              (5U)
#define D_Q_TIA_FB_RES_2ND_BIT_MASK            0xf80000U
...
#define ADDR_0X1028                             (UWB_BASE_ADDR + 0x100C)

#define D_LNA_STAGE2_BIAS_SEL_2ND_BIT_OFFSET    (28U)
#define D_LNA_STAGE2_BIAS_SEL_2ND_BIT_LEN       (4U)
#define D_LNA_STAGE2_BIAS_SEL_2ND_BIT_MASK      0xf0000000U

#define D_LNA_STAGE2_BIAS_SEL_BIT_OFFSET        (24U)
#define D_LNA_STAGE2_BIAS_SEL_BIT_LEN           (4U)
#define D_LNA_STAGE2_BIAS_SEL_BIT_MASK          0xf000000U
...
#define ADDR_0X105C                             (UWB_BASE_ADDR + 0x105C)

#define D_LNA_STAGE1_BIAS2_SEL_BIT_OFFSET      (26U)
#define D_LNA_STAGE1_BIAS2_SEL_BIT_LEN         (3U)
#define D_LNA_STAGE1_BIAS2_SEL_BIT_MASK        0x1c000000U

#define D_LNA_STAGE1_BIAS2_SEL_2ND_BIT_OFFSET  (29U)
#define D_LNA_STAGE1_BIAS2_SEL_2ND_BIT_LEN     (3U)
#define D_LNA_STAGE1_BIAS2_SEL_2ND_BIT_MASK    0xe0000000U
...
//lna_stage1_bias<2:0> lna_stage1_bias2<2:0> lna_stage2_bias_sel<3:0> d_lna_stage2_agc<1:0> tia_fb_res<4:0>

uint32_t tia_gain_table[]={0x1FFE2,0x1FFE4,0x1FFE8,0x1FFD0,0x1FAB0,0x1F910,0x1F890,0x1C090,0x04090,0x00090};
///gain_db               ={68.4,   64.8,   60.7,   55.7,   50.9,   43.9,   35.9,   30.4,   23.5,   12.8};

void zn_set_tia_lna_gain(uint32_t gain_table)
{
    uint32_t lna_stage1_bias;
    uint32_t lna_stage1_bias2;
    uint32_t lna_stage2_bias_sel;
    uint32_t d_lna_stage2_agc;
    uint32_t tia_fb_res;
    lna_stage1_bias     = (gain_table>>14) & 0x7;
    lna_stage1_bias2    = (gain_table>>11) & 0x7;
    lna_stage2_bias_sel = (gain_table>>7) & 0xf;
    d_lna_stage2_agc    = (gain_table>>5) & 0x3;
    tia_fb_res          = gain_table & 0x1f;
    uint32_t reg_value = 0;
    zn_set_d_lna_stage1_bias_sel(lna_stage1_bias);
    zn_set_d_lna_stage1_bias2_sel(lna_stage1_bias2);
    zn_set_d_lna_stage2_bias_sel(lna_stage2_bias_sel);
    zn_set_d_lna_stage2_agc(d_lna_stage2_agc);
    zn_set_d_i_tia_fb_res(tia_fb_res);
    zn_set_d_q_tia_fb_res(tia_fb_res);

}
void zn_set_d_lna_stage2_bias_sel_2nd(uint32_t d_lna_stage2_bias_sel_2nd)
{
    zn_set_reg_field_wr(ADDR_0X1028,
        ...
        d_lna_stage2_bias_sel_2nd);
}
void zn_set_d_lna_stage2_bias_sel(uint32_t d_lna_stage2_bias_sel)
{
    zn_set_reg_field_wr(ADDR_0X1028,
        D_LNA_STAGE2_BIAS_SEL_BIT_MASK,
        D_LNA_STAGE2_BIAS_SEL_BIT_LEN,
        D_LNA_STAGE2_BIAS_SEL_BIT_OFFSET,
        d_lna_stage2_bias_sel);
}

void zn_set_d_q_tia_fb_res(uint32_t d_q_tia_fb_res)
{
    zn_set_reg_field_wr(ADDR_0X0820,
        D_Q_TIA_FB_RES_BIT_MASK,
        D_Q_TIA_FB_RES_BIT_OFFSET,
        D_Q_TIA_FB_RES_BIT_LEN,
        d_q_tia_fb_res);
}
void zn_set_d_i_tia_fb_res(uint32_t d_i_tia_fb_res)
{
...
void zn_set_d_i_tia_stag1_isel(uint32_t d_i_tia_stag1_isel)
{
    zn_set_reg_field_wr(ADDR_0X0818,
...
void zn_set_d_i_tia_stg1_itrim(uint32_t d_i_tia_stg1_itrim)
{
    zn_set_reg_field_wr(ADDR_0X0818,
...
void zn_set_d_q_tia_fb_res_2nd(uint32_t d_q_tia_fb_res_2nd)
{
    zn_set_reg_field_wr(ADDR_0X0850,
                                        D_Q_TIA_FB_RES_2ND_BIT_MASK,
                                        D_Q_TIA_FB_RES_2ND_BIT_OFFSET,
                                        D_Q_TIA_FB_RES_2ND_BIT_LEN,
                                        d_q_tia_fb_res_2nd);
}
void zn_set_d_i_tia_fb_res_2nd(uint32_t d_i_tia_fb_res_2nd)
{
    zn_set_reg_field_wr(ADDR_0X0850,
...
void zn_set_tia_lna_gain_2nd(uint32_t gain_table)
{
    ...
    tia_fb_res = gain_table & 0x1f;
    uint32_t reg_value = 0;
    zn_set_d_lna_stage1_bias_sel_2nd(lna_stage1_bias);
    zn_set_d_lna_stage1_bias2_sel_2nd(lna_stage1_bias2);
    zn_set_d_lna_stage2_bias_sel_2nd(lna_stage2_bias_sel);
    zn_set_d_lna_stage2_agc_2nd(d_lna_stage2_agc);
    zn_set_d_i_tia_fb_res_2nd(tia_fb_res);
    zn_set_d_q_tia_fb_res_2nd(tia_fb_res);
...
void zn_set_d_lna_stage1_bias2_sel_2nd(uint32_t d_lna_stage1_bias2_sel_2nd)
{
    zn_set_reg_field_wr(ADDR_0X105C,
        D_LNA_STAGE1_BIAS2_SEL_2ND_BIT_MASK,
        D_LNA_STAGE1_BIAS2_SEL_2ND_BIT_LEN,
        D_LNA_STAGE1_BIAS2_SEL_2ND_BIT_OFFSET,
        d_lna_stage1_bias2_sel_2nd);
}
...
void zn_set_d_lna_stage1_bias2_sel(uint32_t lna_stage1_bias2_sel)
{
    zn_set_reg_field_wr(ADDR_0X105C,
        D_LNA_STAGE1_BIAS2_SEL_BIT_MASK,
        D_LNA_STAGE1_BIAS2_SEL_BIT_LEN,
        D_LNA_STAGE1_BIAS2_SEL_BIT_OFFSET,
        lna_stage1_bias2_sel);
}
...
void zn_set_d_q_tia_dcoc_2ua_en(uint32_t d_q_tia_dcoc_2ua_en)
{
    zn_set_reg_field_wr(ADDR_0X1054,
...
void zn_set_d_q_tia_dcoc_2ua_en_2nd(uint32_t d_q_tia_dcoc_2ua_en_2nd)
{
    zn_set_reg_field_wr(ADDR_0X1054,
        D_Q_TIA_DCOC_2UA_EN_2ND_BIT_MASK,
        D_Q_TIA_DCOC_2UA_EN_2ND_BIT_LEN,
        D_Q_TIA_DCOC_2UA_EN_2ND_BIT_OFFSET,
        d_q_tia_dcoc_2ua_en_2nd);
}
void zn_set_d_i_tia_dcoc_2ua_en(uint32_t d_i_tia_dcoc_2ua_en)
{
    zn_set_reg_field_wr(ADDR_0X1054,
